...
static bool8 MailReadBuildGraphics(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 10:
            ...
            ExtractToBgTilemapBuffer(1, sMailGraphics[sMailRead->mailType].tileMap, 0);
            break;
        case 11:
        ...
        case 12:
            ...
            gPlttBufferUnfaded[BG_PLTT_ID(0) + 10] = sBgColors[gSaveBlock2.playerGender][0];
            gPlttBufferFaded[BG_PLTT_ID(0) + 10] = sBgColors[gSaveBlock2.playerGender][0];
            gPlttBufferUnfaded[BG_PLTT_ID(0) + 11] = sBgColors[gSaveBlock2.playerGender][1];
            gPlttBufferFaded[BG_PLTT_ID(0) + 11] = sBgColors[gSaveBlock2.playerGender][1];
            break;
        case 13:
