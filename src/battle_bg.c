...
void DrawMainBattleBackground(void)
{
    ...
    else
    {
        ...
        case MAP_BATTLE_SCENE_NORMAL:
            LZ77UnCompVram(sBattleTerrainTable[gBattleTerrain].tileset, (void *)(BG_CHAR_ADDR(2)));
            LZ77UnCompVram(sBattleTerrainTable[gBattleTerrain].tilemap, (void *)(BG_SCREEN_ADDR(26)));
...
void DrawBattleEntryBackground(void)
{
    ...
    else if (gBattleTypeFlags & (BATTLE_TYPE_FRONTIER | BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_EREADER_TRAINER))
    {
        ...
        {
            LZ77UnCompVram(gBattleTerrainAnimTiles_Building, (void *)(BG_CHAR_ADDR(1)));
            LZ77UnCompVram(gBattleTerrainAnimTilemap_Building, (void *)(BG_SCREEN_ADDR(28)));
        }
        else
        {
    ...
    {
        LZ77UnCompVram(gBattleTerrainAnimTiles_Cave, (void *)(BG_CHAR_ADDR(1)));
        LZ77UnCompVram(gBattleTerrainAnimTilemap_Cave, (void *)(BG_SCREEN_ADDR(28)));
    }
    else if (gBattleTypeFlags & BATTLE_TYPE_KYOGRE)
    {
        LZ77UnCompVram(gBattleTerrainAnimTiles_Underwater, (void *)(BG_CHAR_ADDR(1)));
        LZ77UnCompVram(gBattleTerrainAnimTilemap_Underwater, (void *)(BG_SCREEN_ADDR(28)));
    }
    else if (gBattleTypeFlags & BATTLE_TYPE_RAYQUAZA)
    {
        LZ77UnCompVram(gBattleTerrainAnimTiles_Rayquaza, (void *)(BG_CHAR_ADDR(1)));
        LZ77UnCompVram(gBattleTerrainAnimTilemap_Rayquaza, (void *)(BG_SCREEN_ADDR(28)));
    }
    else
    {
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        ...
        {
            LZ77UnCompVram(sBattleTerrainTable[gBattleTerrain].entryTileset, (void *)(BG_CHAR_ADDR(1)));
            LZ77UnCompVram(sBattleTerrainTable[gBattleTerrain].entryTilemap, (void *)(BG_SCREEN_ADDR(28)));
        }
        else
        {
            LZ77UnCompVram(gBattleTerrainAnimTiles_Building, (void *)(BG_CHAR_ADDR(1)));
