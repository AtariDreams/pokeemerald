...
static void GetChallengeStatus(void)
{
    ...
    case CHALLENGE_STATUS_SAVING:
        ...
        VarSet(VAR_TEMP_0, gSaveBlock2.frontier.challengeStatus);
        break;
...
static void GiveBattlePoints(void)
{
    ...
    case FRONTIER_FACILITY_DOME:
        ...
        break;
    case FRONTIER_FACILITY_PALACE:
        challengeNum = gSaveBlock2.frontier.palaceWinStreaks[battleMode][lvlMode] / 7;
        break;
    case FRONTIER_FACILITY_ARENA:
        challengeNum = gSaveBlock2.frontier.arenaWinStreaks[lvlMode] / 7;
        break;
    case FRONTIER_FACILITY_FACTORY:
        challengeNum = gSaveBlock2.frontier.factoryWinStreaks[battleMode][lvlMode] / 7;
        break;
    case FRONTIER_FACILITY_PIKE:
        challengeNum = gSaveBlock2.frontier.pikeWinStreaks[lvlMode] / 14;
        break;
    case FRONTIER_FACILITY_PYRAMID:
        challengeNum = gSaveBlock2.frontier.pyramidWinStreaks[lvlMode] / 7;
        break;
    }
...
static void IncrementWinStreak(void)
{
    ...
    case FRONTIER_FACILITY_TOWER:
        if (gSaveBlock2.frontier.towerWinStreaks[battleMode][lvlMode] < MAX_STREAK)
        {
            ...
            if (battleMode == FRONTIER_MODE_SINGLES)
            {
                SetGameStat(GAME_STAT_BATTLE_TOWER_BEST_STREAK, gSaveBlock2.frontier.towerWinStreaks[battleMode][lvlMode]);
