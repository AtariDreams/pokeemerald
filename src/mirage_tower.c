...
{
    if (!(gSaveBlock1.location.mapGroup == MAP_GROUP(ROUTE111) && gSaveBlock1.location.mapNum == MAP_NUM(ROUTE111)))
        return FALSE;
...
static void PlayerDescendMirageTower(u8 taskId)
{
    ...
    TryGetObjectEventIdByLocalIdAndMap(LOCALID_ROUTE111_PLAYER_FALLING, gSaveBlock1.location.mapNum, gSaveBlock1.location.mapGroup, &objectEventId);
