...
static void Task_LinkupExchangeDataWithLeader(u8 taskId)
{
    ...
    else
    {
        ...
        card->monSpecies[0] = GetMonData(&gPlayerParty.party[gSelectedOrderFromParty[0] - 1], MON_DATA_SPECIES, NULL);
        card->monSpecies[1] = GetMonData(&gPlayerParty.party[gSelectedOrderFromParty[1] - 1], MON_DATA_SPECIES, NULL);
