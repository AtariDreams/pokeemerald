...
static const u8 sRibbonIconsSmall_Gfx[] = INCBIN_U8("graphics/pokenav/ribbons/icons.4bpp.lz");
static const u8 sRibbonIconsBig_Gfx[] = INCBIN_U8("graphics/pokenav/ribbons/icons_big.4bpp.lz");
...
void CreateRibbonsSummaryLoopedTask(u32 id)
{
