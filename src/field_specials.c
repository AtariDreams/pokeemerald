...
static void PCTurnOnEffect_SetMetatile(s16 isScreenOn, s8 dx, s8 dy)
{
    ...
    MapGridSetMetatileIdAt(gSaveBlock1.pos.x + dx + MAP_OFFSET, gSaveBlock1.pos.y + dy + MAP_OFFSET, metatileId | MAPGRID_COLLISION_MASK);
}
