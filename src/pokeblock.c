...
{
    struct Pokeblock *pkblock = &gSaveBlock1.pokeblocks[pkblId];
...
static void DrawPokeblockInfo(s32 pkblId)
{
    ...
    {
        pokeblock = &gSaveBlock1.pokeblocks[pkblId];
...
static void CompactPokeblockSlots(void)
{
    ...
    for (i = 0; i < POKEBLOCKS_COUNT - 1; i++)
    {
        ...
        {
            if (gSaveBlock1.pokeblocks[i].color == PBLOCK_CLR_NONE)
            {
                struct Pokeblock temp = gSaveBlock1.pokeblocks[i];
                gSaveBlock1.pokeblocks[i] = gSaveBlock1.pokeblocks[j];
                gSaveBlock1.pokeblocks[j] = temp;
            }
        }
    }
}
...
static void UsePokeblockOnField(void)
{
    ChooseMonToGivePokeblock(&gSaveBlock1.pokeblocks[gSpecialVar_ItemId], ReturnToPokeblockCaseOnField);
}
...
{
    u8 nature = GetNature(&gEnemyParty.party[0]);
    s16 gain = PokeblockGetGain(nature, &gSaveBlock1.pokeblocks[gSpecialVar_ItemId]);
...
{
    gSpecialVar_0x8004 = GivePokeblockToContestLady(&gSaveBlock1.pokeblocks[gSpecialVar_ItemId]);
    gSpecialVar_Result = gSpecialVar_ItemId;
    TryClearPokeblock(gSpecialVar_ItemId);
    gSpecialVar_ItemId = 0;
    FadePaletteAndSetTaskToClosePokeblockCase(taskId);
...
{
    gSaveBlock1.pokeblocks[pkblId].color = 0;
    gSaveBlock1.pokeblocks[pkblId].spicy = 0;
    gSaveBlock1.pokeblocks[pkblId].dry = 0;
    gSaveBlock1.pokeblocks[pkblId].sweet = 0;
    gSaveBlock1.pokeblocks[pkblId].bitter = 0;
    gSaveBlock1.pokeblocks[pkblId].sour = 0;
    gSaveBlock1.pokeblocks[pkblId].feel = 0;
}
...
{
    if (gSaveBlock1.pokeblocks[pkblId].color == PBLOCK_CLR_NONE)
    {
        return FALSE;
    }
    else
