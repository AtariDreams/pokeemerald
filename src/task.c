...
{
    gTasks[taskId].data[NUM_TASK_DATA - 2] = (s16)((u32)followupFunc);
    gTasks[taskId].data[NUM_TASK_DATA - 1] = (s16)((u32)followupFunc >> 16); // Store followupFunc as two half-words in the data array.
    gTasks[taskId].func = func;
}

void SwitchTaskToFollowupFunc(u8 taskId)
{
    gTasks[taskId].func = (TaskFunc)((u16)(gTasks[taskId].data[NUM_TASK_DATA - 2]) | (gTasks[taskId].data[NUM_TASK_DATA - 1] << 16));
}
