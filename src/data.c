...
const u8 gMinigameDigits_Gfx[] = INCBIN_U8("graphics/link/minigame_digits.4bpp.lz");
static const u8 sMinigameDigitsThin_Gfx[] = INCBIN_U8("graphics/link/minigame_digits2.4bpp.lz"); // Unused
