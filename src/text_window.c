...
{
    LoadWindowGfx(windowId, gSaveBlock2.optionsWindowFrameType, destOffset, palOffset);
}
...
{
    LoadBgTiles(bg, sWindowFrames[gSaveBlock2.optionsWindowFrameType].tiles, 0x120, destOffset);
    LoadPalette(GetWindowFrameTilesPal(gSaveBlock2.optionsWindowFrameType)->pal, palOffset, PLTT_SIZE_4BPP);
}
