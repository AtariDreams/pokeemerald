...
const u8 gIntroVolbeat_Gfx[] = INCBIN_U8("graphics/intro/scene_2/volbeat.4bpp.lz");
const u8 gIntroTorchic_Gfx[] = INCBIN_U8("graphics/intro/scene_2/torchic.4bpp.lz");
const u8 gIntroManectric_Gfx[] = INCBIN_U8("graphics/intro/scene_2/manectric.4bpp.lz");
const u8 gIntroFlygon_Gfx[] = INCBIN_U8("graphics/intro/scene_2/flygon.4bpp.lz");
const u8 gIntroBrendan_Gfx[] = INCBIN_U8("graphics/intro/scene_2/brendan.4bpp.lz");
const u8 gIntroMay_Gfx[] = INCBIN_U8("graphics/intro/scene_2/may.4bpp.lz");

const u8 gIntroGroudon_Gfx[] = INCBIN_U8("graphics/intro/scene_3/groudon.8bpp.lz");
const u32 gIntroGroudon_Tilemap[] = INCBIN_U32("graphics/intro/scene_3/groudon.bin.lz");

const u8 gIntroKyogre_Gfx[] = INCBIN_U8("graphics/intro/scene_3/kyogre.8bpp.lz");
const u32 gIntroKyogre_Tilemap[] = INCBIN_U32("graphics/intro/scene_3/kyogre.bin.lz");

const u8 gIntroLegendBg_Gfx[] = INCBIN_U8("graphics/intro/scene_3/legend_bg.4bpp.lz"); // groudon/kyogre bg
...
const u8 gIntroClouds_Gfx[] = INCBIN_U8("graphics/intro/scene_3/clouds.4bpp.lz");
...
const u8 gIntroLightning_Gfx[] = INCBIN_U8("graphics/intro/scene_3/lightning.4bpp.lz");
const u16 gIntroLightning_Pal[] = INCBIN_U16("graphics/intro/scene_3/lightning.gbapal");

const u8 gIntroRayquaza_Gfx[] = INCBIN_U8("graphics/intro/scene_3/rayquaza.4bpp.lz");
...
const u8 gIntroRayquazaClouds_Gfx[] = INCBIN_U8("graphics/intro/scene_3/rayquaza_clouds.4bpp.lz");
const u32 gIntroRayquazaClouds_Tilemap[] = INCBIN_U32("graphics/intro/scene_3/rayquaza_clouds.bin.lz");

const u8 gIntroBubbles_Gfx[] = INCBIN_U8("graphics/intro/scene_3/bubbles.4bpp.lz");
const u16 gIntroBubbles_Pal[] = INCBIN_U16("graphics/intro/scene_3/bubbles.gbapal");

const u8 gIntroFlygonSilhouette_Gfx[] = INCBIN_U8("graphics/intro/scene_1/flygon.4bpp.lz");
const u8 gIntroSparkle_Gfx[] = INCBIN_U8("graphics/intro/scene_1/sparkle.4bpp.lz");
