...
const u8 gRaySceneDuoFight_Groudon_Gfx[]           = INCBIN_U8("graphics/rayquaza_scene/scene_1/groudon.4bpp.lz");
const u8 gRaySceneDuoFight_GroudonShoulder_Gfx[]   = INCBIN_U8("graphics/rayquaza_scene/scene_1/groudon_shoulder.4bpp.lz");
const u8 gRaySceneDuoFight_GroudonClaw_Gfx[]       = INCBIN_U8("graphics/rayquaza_scene/scene_1/groudon_claw.4bpp.lz");
const u8 gRaySceneDuoFight_Kyogre_Gfx[]            = INCBIN_U8("graphics/rayquaza_scene/scene_1/kyogre.4bpp.lz");
const u8 gRaySceneDuoFight_KyogrePectoralFin_Gfx[] = INCBIN_U8("graphics/rayquaza_scene/scene_1/kyogre_pectoral_fin.4bpp.lz");
const u8 gRaySceneDuoFight_KyogreDorsalFin_Gfx[]   = INCBIN_U8("graphics/rayquaza_scene/scene_1/kyogre_dorsal_fin.4bpp.lz");
...
const u8 gRaySceneDuoFight_Clouds_Gfx[]            = INCBIN_U8("graphics/rayquaza_scene/scene_1/clouds.4bpp.lz");
...
const u8 gRaySceneTakesFlight_Smoke_Gfx[]        = INCBIN_U8("graphics/rayquaza_scene/scene_2/smoke.4bpp.lz");
const u32 gRaySceneTakesFlight_Smoke_Pal[]        = INCBIN_U32("graphics/rayquaza_scene/scene_2/smoke.gbapal.lz");
const u8 gRaySceneTakesFlight_Rayquaza_Gfx[]     = INCBIN_U8("graphics/rayquaza_scene/scene_2/rayquaza.8bpp.lz");
...
const u8 gRaySceneTakesFlight_Bg_Gfx[]           = INCBIN_U8("graphics/rayquaza_scene/scene_2/bg.4bpp.lz"); // uses pal 2 of gRaySceneTakesFlight_Rayquaza_Pal
const u32 gRaySceneTakesFlight_Bg_Tilemap[]       = INCBIN_U32("graphics/rayquaza_scene/scene_2/bg.bin.lz");

// Scene 3 (RAY_ANIM_DESCENDS)
const u8 gRaySceneDescends_Rayquaza_Gfx[]     = INCBIN_U8("graphics/rayquaza_scene/scene_3/rayquaza.4bpp.lz");
...
const u8 gRaySceneDescends_RayquazaTail_Gfx[] = INCBIN_U8("graphics/rayquaza_scene/scene_3/rayquaza_tail_fix.4bpp.lz");
const u8 gRaySceneDescends_Bg_Gfx[]           = INCBIN_U8("graphics/rayquaza_scene/scene_3/bg.4bpp.lz");
const u8 gRaySceneDescends_Light_Gfx[]        = INCBIN_U8("graphics/rayquaza_scene/scene_3/light.4bpp.lz"); // uses pal 2 of gRaySceneDescends_Bg_Pal
...
const u8 gRaySceneCharges_Bg_Gfx[]           = INCBIN_U8("graphics/rayquaza_scene/scene_4/bg.4bpp.lz");
const u32 gRaySceneCharges_Bg_Tilemap[]       = INCBIN_U32("graphics/rayquaza_scene/scene_4/bg.bin.lz");
const u8 gRaySceneCharges_Streaks_Gfx[]      = INCBIN_U8("graphics/rayquaza_scene/scene_4/streaks.4bpp.lz");
const u32 gRaySceneCharges_Streaks_Tilemap[]  = INCBIN_U32("graphics/rayquaza_scene/scene_4/streaks.bin.lz");
const u8 gRaySceneCharges_Rayquaza_Gfx[]     = INCBIN_U8("graphics/rayquaza_scene/scene_4/rayquaza.4bpp.lz");
...
const u8 gRaySceneChasesAway_Groudon_Gfx[]      = INCBIN_U8("graphics/rayquaza_scene/scene_5/groudon.4bpp.lz");
const u8 gRaySceneChasesAway_GroudonTail_Gfx[]  = INCBIN_U8("graphics/rayquaza_scene/scene_5/groudon_tail.4bpp.lz");
const u8 gRaySceneChasesAway_Kyogre_Gfx[]       = INCBIN_U8("graphics/rayquaza_scene/scene_5/kyogre.4bpp.lz");
const u8 gRaySceneChasesAway_Rayquaza_Gfx[]     = INCBIN_U8("graphics/rayquaza_scene/scene_5/rayquaza.4bpp.lz");
const u8 gRaySceneChasesAway_RayquazaTail_Gfx[] = INCBIN_U8("graphics/rayquaza_scene/scene_5/rayquaza_tail.4bpp.lz");
const u8 gRaySceneChasesAway_KyogreSplash_Gfx[] = INCBIN_U8("graphics/rayquaza_scene/scene_5/kyogre_splash.4bpp.lz");
...
const u8 gRaySceneChasesAway_Light_Gfx[]        = INCBIN_U8("graphics/rayquaza_scene/scene_5/light.4bpp.lz");
const u8 gRaySceneChasesAway_Ring_Gfx[]         = INCBIN_U8("graphics/rayquaza_scene/scene_5/ring.8bpp.lz");
