...
static const u16 sGbaAffine_Gfx[] = INCBIN_U16("graphics/trade/gba_affine.8bpp"); // Only the gfx for when the GBA is zooming in/out
static const u16 sGbaAffineMapCable[] = INCBIN_U16("graphics/trade/gba_affine_map_cable.bin");
static const u16 sGbaAffineMapWireless[] = INCBIN_U16("graphics/trade/gba_affine_map_wireless.bin");
