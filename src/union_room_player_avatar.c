...
{
    TrySpawnObjectEvent(sUnionRoomLocalIds[leaderId], gSaveBlock1.location.mapNum, gSaveBlock1.location.mapGroup);
}

static void RemoveUnionRoomPlayerObjectEvent(u32 leaderId)
{
    RemoveObjectEventByLocalIdAndMap(sUnionRoomLocalIds[leaderId], gSaveBlock1.location.mapNum, gSaveBlock1.location.mapGroup);
}
...
static bool32 SetUnionRoomPlayerEnterExitMovement(u32 leaderId, const u8 * movement)
{
    ...
    if (TryGetObjectEventIdByLocalIdAndMap(sUnionRoomLocalIds[leaderId], gSaveBlock1.location.mapNum, gSaveBlock1.location.mapGroup, &objectId))
        return FALSE;
