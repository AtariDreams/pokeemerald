...
static const u8 sPokedexAreaMap_Gfx[] = INCBIN_U8("graphics/pokedex/region_map.8bpp.lz");
static const u32 sPokedexAreaMap_Tilemap[] = INCBIN_U32("graphics/pokedex/region_map.bin.lz");
static const u8 sPokedexAreaMapAffine_Gfx[] = INCBIN_U8("graphics/pokedex/region_map_affine.8bpp.lz");
