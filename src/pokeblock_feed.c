...
static bool8 LoadPokeblockFeedScene(void)
{
    ...
    case 6:
        ...
        break;
    case 7:
        if (LoadMonAndSceneGfx(&gPlayerParty.party[gPokeblockMonId]))
            gMain.state++;
        break;
    case 8:
        ...
        break;
    case 9:
        sPokeblockFeed->monSpriteId = CreateMonSprite(&gPlayerParty.party[gPokeblockMonId]);
        gMain.state++;
        break;
    case 10:
...
{
    u8 colorId = GetPokeblockData(&gSaveBlock1.pokeblocks[pokeblockCaseId], PBLOCK_COLOR);
...
{
    struct Pokemon *mon = &gPlayerParty.party[gPokeblockMonId];
