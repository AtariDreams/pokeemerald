...
static const u8 s321Start_Static_Gfx[] = INCBIN_U8("graphics/link/321start_static.4bpp.lz");
...
static const u8 s321Start_Gfx[] = INCBIN_U8("graphics/link/321start.4bpp.lz");
