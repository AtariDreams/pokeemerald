...
static const u16 sCryMeter_Gfx[] = INCBIN_U16("graphics/pokedex/cry_meter.4bpp.lz");
...
static const u16 sCryScreenBg_Gfx[] = INCBIN_U16("graphics/pokedex/cry_screen_bg.4bpp");
...
bool8 LoadCryWaveformWindow(struct CryScreenWindow *window, u8 windowId)
{
    ...
    case 0:
        if (!sDexCryScreen)
        {
            ...
            sCryWaveformWindowTiledata = (u8 *)gWindows[windowId].tileData;
        }
