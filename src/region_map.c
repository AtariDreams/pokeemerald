...
#define ZOOM_LEFT_LIMIT (MAPBLOCK_TO_POS(MAPCURSOR_X_MIN) - ZOOM_CENTER_X_POS)
#define ZOOM_RIGHT_LIMIT (MAPBLOCK_TO_POS(MAPCURSOR_X_MAX) - ZOOM_CENTER_X_POS)
#define ZOOM_UPPER_LIMIT (MAPBLOCK_TO_POS(MAPCURSOR_Y_MIN) - ZOOM_CENTER_Y_POS)
#define ZOOM_LOWER_LIMIT (MAPBLOCK_TO_POS(MAPCURSOR_Y_MAX) - ZOOM_CENTER_Y_POS)
#define ZOOM_SYNC 16

#define ZOOM_TO_XPOS(x) ((((x)-ZOOM_LEFT_LIMIT) / 8) + MAPCURSOR_X_MIN)
#define ZOOM_TO_YPOS(y) ((((y)-ZOOM_UPPER_LIMIT) / 8) + MAPCURSOR_Y_MIN)
