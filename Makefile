...
$(C_BUILDDIR)/agb_flash.o: CFLAGS := -mthumb-interwork -Ofast -fgcse-las -fgcse-sm -fipa-pta -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t -mthumb -fno-toplevel-reorder
endif
