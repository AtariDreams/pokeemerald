...
override CFLAGS += -mthumb -mthumb-interwork -O3 -mabi=apcs-gnu -mcpu=arm7tdmi -Wno-pointer-to-int-cast -fno-toplevel-reorder
ROM := $(MODERN_ROM_NAME)
...
$(GFLIB_BUILDDIR)/malloc.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/dma3_manager.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/gpu_regs.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/bg.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/blit.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/window.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(GFLIB_BUILDDIR)/text.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(C_BUILDDIR)/librfu_intr.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(C_BUILDDIR)/math_util.o: CFLAGS := -mthumb-interwork -O3 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -Wno-pointer-to-int-cast
endif
