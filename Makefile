...
override CFLAGS += -mthumb-interwork -Ofast -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t  -Wno-pointer-to-int-cast -mthumb
ROM := $(MODERN_ROM_NAME)
...
$(C_BUILDDIR)/librfu_intr.o: CFLAGS := -mthumb-interwork -Ofast -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
$(C_BUILDDIR)/math_util.o: CFLAGS := -mthumb-interwork -Ofast -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t -Wno-pointer-to-int-cast
$(C_BUILDDIR)/m4a.o: CFLAGS := -mthumb-interwork -Ofast -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t -mthumb -fno-toplevel-reorder
$(C_BUILDDIR)/agb_flash.o: CFLAGS := -mthumb-interwork -Ofast -fomit-frame-pointer -mabi=aapcs -mtune=arm7tdmi -march=armv4t -mthumb -fno-toplevel-reorder
endif
