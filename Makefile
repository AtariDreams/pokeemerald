...
override CFLAGS += -mthumb -mthumb-interwork -O2 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -std=c11
ROM := $(MODERN_ROM_NAME)
...
$(C_BUILDDIR)/librfu_intr.o: CFLAGS := -mthumb-interwork -O2 -std=c11 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast
endif
