...
override CFLAGS += -mthumb -mthumb-interwork -O2 -mabi=apcs-gnu -march=armv4t -mtune=arm7tdmi -mcpu=arm7tdmi -fno-toplevel-reorder -Wno-pointer-to-int-cast -Wno-pointer-to-int-cast -fallow-store-data-races -msoft-float #-flto -ffat-lto-objects -fuse-linker-plugin
ROM := $(MODERN_ROM_NAME)
...
$(C_BUILDDIR)/librfu_intr.o: CFLAGS := -mthumb-interwork -O2 -mabi=apcs-gnu -march=armv4t -mtune=arm7tdmi -mcpu=arm7tdmi -fno-toplevel-reorder -Wno-pointer-to-int-cast -fallow-store-data-races -msoft-float  #-flto -ffat-lto-objects -fuse-linker-plugin
endif
