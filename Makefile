...
override CFLAGS += -mthumb -mthumb-interwork -O2 -mabi=aapcs -mcpu=arm7tdmi -fno-toplevel-reorder -Wno-pointer-to-int-cast -Wno-pointer-to-int-cast -fallow-store-data-races -msoft-float #-flto -fuse-linker-plugin
ROM := $(MODERN_ROM_NAME)
