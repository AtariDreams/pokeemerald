...
// pokeballs
extern const u8 gBallGfx_Poke[];
extern const u32 gBallPal_Poke[];
extern const u8 gBallGfx_Great[];
extern const u32 gBallPal_Great[];
extern const u8 gBallGfx_Safari[];
extern const u32 gBallPal_Safari[];
extern const u8 gBallGfx_Ultra[];
extern const u32 gBallPal_Ultra[];
extern const u8 gBallGfx_Master[];
extern const u32 gBallPal_Master[];
extern const u8 gBallGfx_Net[];
extern const u32 gBallPal_Net[];
extern const u8 gBallGfx_Dive[];
extern const u32 gBallPal_Dive[];
extern const u8 gBallGfx_Nest[];
extern const u32 gBallPal_Nest[];
extern const u8 gBallGfx_Repeat[];
extern const u32 gBallPal_Repeat[];
extern const u8 gBallGfx_Timer[];
extern const u32 gBallPal_Timer[];
extern const u8 gBallGfx_Luxury[];
extern const u32 gBallPal_Luxury[];
extern const u8 gBallGfx_Premier[];
...
extern const u8 gTrainerFrontPic_PokefanM[];
extern const u8 gTrainerFrontPic_PokefanF[];
...
extern const u8 gVsLettersGfx[];
extern const u8 gBattleVSFrame_Gfx[];
...
// pokedex
extern const u8 gPokedexInterface_Gfx[];
...
// rayquaza scene gfx
extern const u8 gRaySceneDuoFight_Groudon_Gfx[];
extern const u8 gRaySceneDuoFight_GroudonShoulder_Gfx[];
extern const u8 gRaySceneDuoFight_GroudonClaw_Gfx[];
extern const u8 gRaySceneDuoFight_Kyogre_Gfx[];
extern const u8 gRaySceneDuoFight_KyogrePectoralFin_Gfx[];
extern const u8 gRaySceneDuoFight_KyogreDorsalFin_Gfx[];
extern const u32 gRaySceneDuoFight_Groudon_Pal[];
extern const u32 gRaySceneDuoFight_Kyogre_Pal[];
extern const u8 gRaySceneDuoFight_Clouds_Gfx[];
...
extern const u8 gRaySceneTakesFlight_Smoke_Gfx[];
extern const u32 gRaySceneTakesFlight_Smoke_Pal[];
extern const u32 gRaySceneTakesFlight_Rayquaza_Pal[];
extern const u8 gRaySceneTakesFlight_Bg_Gfx[];
extern const u32 gRaySceneTakesFlight_Bg_Tilemap[];
extern const u8 gRaySceneTakesFlight_Rayquaza_Gfx[];
extern const u32 gRaySceneTakesFlight_Rayquaza_Tilemap[];
extern const u8 gRaySceneDescends_Rayquaza_Gfx[];
extern const u8 gRaySceneDescends_RayquazaTail_Gfx[];
extern const u8 gRaySceneDescends_Light_Gfx[];
extern const u32 gRaySceneDescends_Light_Tilemap[];
extern const u8 gRaySceneDescends_Bg_Gfx[];
extern const u32 gRaySceneDescends_Bg_Tilemap[];
extern const u32 gRaySceneDescends_Bg_Pal[];
extern const u8 gRaySceneCharges_Rayquaza_Gfx[];
extern const u8 gRaySceneCharges_Streaks_Gfx[];
extern const u8 gRaySceneCharges_Bg_Gfx[];
...
extern const u8 gRaySceneChasesAway_Groudon_Gfx[];
extern const u8 gRaySceneChasesAway_GroudonTail_Gfx[];
extern const u8 gRaySceneChasesAway_Kyogre_Gfx[];
extern const u8 gRaySceneChasesAway_Rayquaza_Gfx[];
extern const u8 gRaySceneChasesAway_RayquazaTail_Gfx[];
extern const u8 gRaySceneChasesAway_KyogreSplash_Gfx[];
...
extern const u8 gRaySceneChasesAway_Light_Gfx[];
extern const u8 gRaySceneChasesAway_Ring_Gfx[];
...
extern const u8 gBagScreen_GfxTileMap[];
...
//intro graphics
extern const u8 gIntroSparkle_Gfx[];
extern const u8 gIntroFlygonSilhouette_Gfx[];
extern const u8 gIntroLightning_Gfx[];
...
extern const u8 gIntroRayquaza_Gfx[];
extern const u8 gIntroRayquazaClouds_Gfx[];
extern const u32 gIntroRayquazaClouds_Tilemap[];
extern const u16 gIntroGameFreakTextFade_Pal[];
extern const u8 gIntroBrendan_Gfx[];
extern const u8 gIntroMay_Gfx[];
extern const u16 gIntroPlayer_Pal[];
extern const u16 gIntroFlygon_Pal[];
extern const u8 gIntroFlygon_Gfx[];

// party menu graphics
extern const u8 gPartyMenuBg_Gfx[];
...
extern const u8 gPokenavCondition_Gfx[];
extern const u32 gPokenavCondition_Tilemap[];
extern const u16 gPokenavOptions_Tilemap[];
extern const u8 gPokenavOptions_Gfx[];
extern const u16 gPokenavOptions_Pal[];
extern const u16 gPokenavLeftHeader_Pal[];
extern const u16 gPokenavHeader_Pal[];
extern const u8 gPokenavHeader_Gfx[];
extern const u32 gPokenavHeader_Tilemap[];
extern const u8 gPokenavLeftHeaderHoennMap_Gfx[];
extern const u8 gPokenavLeftHeaderMainMenu_Gfx[];
extern const u8 gPokenavLeftHeaderCondition_Gfx[];
extern const u8 gPokenavLeftHeaderRibbons_Gfx[];
extern const u8 gPokenavLeftHeaderMatchCall_Gfx[];
extern const u8 gPokenavLeftHeaderParty_Gfx[];
extern const u8 gPokenavLeftHeaderSearch_Gfx[];
extern const u8 gPokenavLeftHeaderCool_Gfx[];
extern const u8 gPokenavLeftHeaderBeauty_Gfx[];
extern const u8 gPokenavLeftHeaderCute_Gfx[];
extern const u8 gPokenavLeftHeaderSmart_Gfx[];
extern const u8 gPokenavLeftHeaderTough_Gfx[];
extern const u16 gPokenavRibbonsSummaryBg_Pal[];
extern const u8 gPokenavRibbonsSummaryBg_Gfx[];
extern const u32 gPokenavRibbonsSummaryBg_Tilemap[];

extern const u8 gSummaryScreen_Gfx[];
...
extern const u8 gConfetti_Gfx[];
extern const u32 gConfetti_Pal[];

extern const u32 gBattleInterfaceGfx_BattleBar[];
extern const u8 gSubstituteDollBackGfx[];
extern const u8 gSubstituteDollFrontGfx[];
...
extern const u8 gSwapLineGfx[];
extern const u32 gSwapLinePal[];

extern const u8 gBattlePyramidBag_Gfx[];
...
// Battle Dome
extern const u8 gDomeTourneyInfoCard_Gfx[];
...
extern const u8 gDomeTourneyTree_Gfx[];
extern const u8 gDomeTourneyLine_Gfx[];
...
extern const u8 gSmokescreenImpactTiles[];
extern const u32 gSmokescreenImpactPalette[];

extern const u8 gBattleAnimSpriteGfx_Bone[];
extern const u8 gBattleAnimSpriteGfx_Spark[];
extern const u8 gBattleAnimSpriteGfx_Pencil[];
extern const u8 gBattleAnimSpriteGfx_AirWave[];
extern const u8 gBattleAnimSpriteGfx_Orb[];
extern const u8 gBattleAnimSpriteGfx_Sword[];
extern const u8 gBattleAnimSpriteGfx_Seed[];
extern const u8 gBattleAnimSpriteGfx_Explosion6[];
extern const u8 gBattleAnimSpriteGfx_PinkOrb[];
extern const u8 gBattleAnimSpriteGfx_Gust[];
extern const u8 gBattleAnimSpriteGfx_IceCube[];
extern const u8 gBattleAnimSpriteGfx_Spark2[];
extern const u8 gBattleAnimSpriteGfx_Orange[];
extern const u8 gBattleAnimSpriteGfx_YellowBall[];
extern const u8 gBattleAnimSpriteGfx_LockOn[];
extern const u8 gBattleAnimSpriteGfx_TiedBag[];
extern const u8 gBattleAnimSpriteGfx_BlackSmoke[];
extern const u8 gBattleAnimSpriteGfx_BlackBall[];
extern const u8 gBattleAnimSpriteGfx_Conversion[];
extern const u8 gBattleAnimSpriteGfx_Glass[];
extern const u8 gBattleAnimSpriteGfx_HornHit[];
extern const u8 gBattleAnimSpriteGfx_Hit[];
extern const u8 gBattleAnimSpriteGfx_Hit[];
extern const u8 gBattleAnimSpriteGfx_BlueShards[];
extern const u8 gBattleAnimSpriteGfx_ClosingEye[];
extern const u8 gBattleAnimSpriteGfx_WavingHand[];
extern const u8 gBattleAnimSpriteGfx_HitDuplicate[];
extern const u8 gBattleAnimSpriteGfx_Leer[];
extern const u8 gBattleAnimSpriteGfx_BlueBurst[];
extern const u8 gBattleAnimSpriteGfx_SmallEmber[];
extern const u8 gBattleAnimSpriteGfx_GraySmoke[];
extern const u8 gBattleAnimSpriteGfx_BlueStar[];
extern const u8 gBattleAnimSpriteGfx_BubbleBurst[];
extern const u8 gBattleAnimSpriteGfx_Fire[];
extern const u8 gBattleAnimSpriteGfx_SpinningFire[];
extern const u8 gBattleAnimSpriteGfx_FirePlume[];
extern const u8 gBattleAnimSpriteGfx_Lightning2[];
extern const u8 gBattleAnimSpriteGfx_Lightning[];
extern const u8 gBattleAnimSpriteGfx_ClawSlash2[];
extern const u8 gBattleAnimSpriteGfx_ClawSlash[];
extern const u8 gBattleAnimSpriteGfx_Scratch3[];
extern const u8 gBattleAnimSpriteGfx_Scratch2[];
extern const u8 gBattleAnimSpriteGfx_BubbleBurst2[];
extern const u8 gBattleAnimSpriteGfx_IceChunk[];
extern const u8 gBattleAnimSpriteGfx_Glass2[];
extern const u8 gBattleAnimSpriteGfx_PinkHeart2[];
extern const u8 gBattleAnimSpriteGfx_SapDrip[];
extern const u8 gBattleAnimSpriteGfx_SapDrip[];
extern const u8 gBattleAnimSpriteGfx_Sparkle1[];
extern const u8 gBattleAnimSpriteGfx_Sparkle1[];
extern const u8 gBattleAnimSpriteGfx_HumanoidFoot[];
extern const u8 gBattleAnimSpriteGfx_MonsterFoot[];
extern const u8 gBattleAnimSpriteGfx_HumanoidHand[];
extern const u8 gBattleAnimSpriteGfx_NoiseLine[];
extern const u8 UnusedLevelupAnimationGfx[];
extern const u32 UnusedLevelupAnimationTilemap[];
extern const u8 gBattleAnimSpriteGfx_YellowUnk[];
extern const u8 gBattleAnimSpriteGfx_RedFist[];
extern const u8 gBattleAnimSpriteGfx_SlamHit[];
extern const u8 gBattleAnimSpriteGfx_Ring[];
extern const u8 gBattleAnimSpriteGfx_Rocks[];
extern const u8 gBattleAnimSpriteGfx_Z[];
extern const u8 gBattleAnimSpriteGfx_YellowUnk2[];
extern const u8 gBattleAnimSpriteGfx_AirSlash[];
extern const u8 gBattleAnimSpriteGfx_SpinningGreenOrbs[];
extern const u8 gBattleAnimSpriteGfx_Leaf[];
extern const u8 gBattleAnimSpriteGfx_Finger[];
extern const u8 gBattleAnimSpriteGfx_PoisonPowder[];
extern const u8 gBattleAnimSpriteGfx_BrownTriangle[];
extern const u8 gBattleAnimSpriteGfx_Sparkle3[];
extern const u8 gBattleAnimSpriteGfx_Sparkle4[];
extern const u8 gBattleAnimSpriteGfx_MusicNotes[];
extern const u8 gBattleAnimSpriteGfx_Duck[];
extern const u8 gBattleAnimSpriteGfx_MudSand[];
extern const u8 gBattleAnimSpriteGfx_Alert[];
extern const u8 gBattleAnimSpriteGfx_BlueFlames[];
extern const u8 gBattleAnimSpriteGfx_BlueFlames2[];
extern const u8 gBattleAnimSpriteGfx_Shock4[];
extern const u8 gBattleAnimSpriteGfx_Shock[];
extern const u8 gBattleAnimSpriteGfx_Bell2[];
extern const u8 gBattleAnimSpriteGfx_PinkGlove[];
extern const u8 gBattleAnimSpriteGfx_BlueLines[];
extern const u8 gBattleAnimSpriteGfx_Impact3[];
extern const u8 gBattleAnimSpriteGfx_Impact2[];
extern const u8 gBattleAnimSpriteGfx_Reticle[];
extern const u8 gBattleAnimSpriteGfx_Breath[];
extern const u8 gBattleAnimSpriteGfx_Anger[];
extern const u8 gBattleAnimSpriteGfx_Snowball[];
extern const u8 gBattleAnimSpriteGfx_Vine[];
extern const u8 gBattleAnimSpriteGfx_Sword2[];
extern const u8 gBattleAnimSpriteGfx_Clapping[];
extern const u8 gBattleAnimSpriteGfx_RedTube[];
extern const u8 gBattleAnimSpriteGfx_Amnesia[];
extern const u8 gBattleAnimSpriteGfx_String2[];
extern const u8 gBattleAnimSpriteGfx_Pencil2[];
extern const u8 gBattleAnimSpriteGfx_Petal[];
extern const u8 gBattleAnimSpriteGfx_BentSpoon[];
extern const u8 gBattleAnimSpriteGfx_Web[];
extern const u8 gBattleAnimSpriteGfx_MilkBottle[];
extern const u8 gBattleAnimSpriteGfx_Coin[];
extern const u8 gBattleAnimSpriteGfx_CrackedEgg[];
extern const u8 gBattleAnimSpriteGfx_HatchedEgg[];
extern const u8 gBattleAnimSpriteGfx_FreshEgg[];
extern const u8 gBattleAnimSpriteGfx_Fangs[];
extern const u8 gBattleAnimSpriteGfx_Explosion2[];
extern const u8 gBattleAnimSpriteGfx_Explosion3[];
extern const u8 gBattleAnimSpriteGfx_WaterDroplet[];
extern const u8 gBattleAnimSpriteGfx_WaterDroplet2[];
extern const u8 gBattleAnimSpriteGfx_Seed2[];
extern const u8 gBattleAnimSpriteGfx_Sprout[];
extern const u8 gBattleAnimSpriteGfx_RedWand[];
extern const u8 gBattleAnimSpriteGfx_PurpleGreenUnk[];
extern const u8 gBattleAnimSpriteGfx_WaterColumn[];
extern const u8 gBattleAnimSpriteGfx_MudUnk[];
extern const u8 gBattleAnimSpriteGfx_RainDrops[];
extern const u8 gBattleAnimSpriteGfx_FurySwipes[];
extern const u8 gBattleAnimSpriteGfx_Vine2[];
extern const u8 gBattleAnimSpriteGfx_Teeth[];
extern const u8 gBattleAnimSpriteGfx_Bone2[];
extern const u8 gBattleAnimSpriteGfx_WhiteBag[];
extern const u8 gBattleAnimSpriteGfx_Unknown[];
extern const u8 gBattleAnimSpriteGfx_PurpleCoral[];
extern const u8 gBattleAnimSpriteGfx_PurpleDroplet[];
extern const u8 gBattleAnimSpriteGfx_Shock2[];
extern const u8 gBattleAnimSpriteGfx_ClosingEye2[];
extern const u8 gBattleAnimSpriteGfx_MetalBall[];
extern const u8 gBattleAnimSpriteGfx_MonsterDoll[];
extern const u8 gBattleAnimSpriteGfx_Whirlwind[];
extern const u8 gBattleAnimSpriteGfx_Whirlwind2[];
extern const u8 gBattleAnimSpriteGfx_Explosion4[];
extern const u8 gBattleAnimSpriteGfx_Explosion5[];
extern const u8 gBattleAnimSpriteGfx_Tongue[];
extern const u8 gBattleAnimSpriteGfx_Smoke[];
extern const u8 gBattleAnimSpriteGfx_Smoke2[];
extern const u8 gBattleAnimSpriteGfx_Impact[];
extern const u8 gBattleAnimSpriteGfx_Particles[];
extern const u8 gBattleAnimSpriteGfx_CircleImpact[];
extern const u8 gBattleAnimSpriteGfx_Scratch[];
extern const u8 gBattleAnimSpriteGfx_Cut[];
extern const u8 gBattleAnimSpriteGfx_SharpTeeth[];
extern const u8 gBattleAnimSpriteGfx_RainbowRings[];
extern const u8 gBattleAnimSpriteGfx_IceCrystals[];
extern const u8 gBattleAnimSpriteGfx_IceSpikes[];
extern const u8 gBattleAnimSpriteGfx_HandsAndFeet[];
extern const u8 gBattleAnimSpriteGfx_MistCloud[];
extern const u8 gBattleAnimSpriteGfx_Clamp[];
//extern const struct CompressedSpriteSheet gBattleAnimSpriteGfx_146[];
extern const u8 gBattleAnimSpriteGfx_Bubble[];
extern const u8 gBattleAnimSpriteGfx_Orbs[];
extern const u8 gBattleAnimSpriteGfx_WaterImpact[];
extern const u8 gBattleAnimSpriteGfx_WaterOrb[];
extern const u8 gBattleAnimSpriteGfx_PoisonBubble[];
extern const u8 gBattleAnimSpriteGfx_ToxicBubble[];
extern const u8 gBattleAnimSpriteGfx_Spikes[];
extern const u8 gBattleAnimSpriteGfx_HornHit2[];
extern const u8 gBattleAnimSpriteGfx_AirWave2[];
extern const u8 gBattleAnimSpriteGfx_SmallBubbles[];
extern const u8 gBattleAnimSpriteGfx_RoundShadow[];
extern const u8 gBattleAnimSpriteGfx_Sunlight[];
extern const u8 gBattleAnimSpriteGfx_Spore[];
extern const u8 gBattleAnimSpriteGfx_Flower[];
extern const u8 gBattleAnimSpriteGfx_RazorLeaf[];
extern const u8 gBattleAnimSpriteGfx_Needle[];
extern const u8 gBattleAnimSpriteGfx_WhirlwindLines[];
extern const u8 gBattleAnimSpriteGfx_GoldRing[];
extern const u8 gBattleAnimSpriteGfx_GreenLightWall[];
extern const u8 gBattleAnimSpriteGfx_BlackBall2[];
extern const u8 gBattleAnimSpriteGfx_SparkH[];
extern const u8 gBattleAnimSpriteGfx_YellowStar[];
extern const u8 gBattleAnimSpriteGfx_LargeFreshEgg[];
extern const u8 gBattleAnimSpriteGfx_ShadowBall[];
extern const u8 gBattleAnimSpriteGfx_Lick[];
extern const u8 gBattleAnimSpriteGfx_VoidLines[];
extern const u8 gBattleAnimSpriteGfx_String[];
extern const u8 gBattleAnimSpriteGfx_WebThread[];
extern const u8 gBattleAnimSpriteGfx_SpiderWeb[];
extern const u8 gBattleAnimSpriteGfx_Lightbulb[];
extern const u8 gBattleAnimSpriteGfx_Slash[];
extern const u8 gBattleAnimSpriteGfx_FocusEnergy[];
extern const u8 gBattleAnimSpriteGfx_SphereToCube[];
extern const u8 gBattleAnimSpriteGfx_Tendrils[];
extern const u8 gBattleAnimSpriteGfx_Eye[];
extern const u8 gBattleAnimSpriteGfx_WhiteShadow[];
extern const u8 gBattleAnimSpriteGfx_TealAlert[];
extern const u8 gBattleAnimSpriteGfx_OpeningEye[];
extern const u8 gBattleAnimSpriteGfx_RoundWhiteHalo[];
extern const u8 gBattleAnimSpriteGfx_FangAttack[];
extern const u8 gBattleAnimSpriteGfx_PurpleHandOutline[];
extern const u8 gBattleAnimSpriteGfx_Moon[];
extern const u8 gBattleAnimSpriteGfx_GreenSparkle[];
extern const u8 gBattleAnimSpriteGfx_Spiral[];
extern const u8 gBattleAnimSpriteGfx_SnoreZ[];
extern const u8 gBattleAnimSpriteGfx_Explosion[];
extern const u8 gBattleAnimSpriteGfx_Nail[];
extern const u8 gBattleAnimSpriteGfx_GhostlySpirit[];
extern const u8 gBattleAnimSpriteGfx_WarmRock[];
extern const u8 gBattleAnimSpriteGfx_BreakingEgg[];
extern const u8 gBattleAnimSpriteGfx_ThinRing[];
extern const u8 gBattleAnimSpriteGfx_PunchImpact[];
extern const u8 gBattleAnimSpriteGfx_Bell[];
extern const u8 gBattleAnimSpriteGfx_MusicNotes2[];
extern const u8 gBattleAnimSpriteGfx_SpeedDust[];
extern const u8 gBattleAnimSpriteGfx_TornMetal[];
extern const u8 gBattleAnimSpriteGfx_ThoughtBubble[];
extern const u8 gBattleAnimSpriteGfx_MagentaHeart[];
extern const u8 gBattleAnimSpriteGfx_ElectricOrbs[];
extern const u8 gBattleAnimSpriteGfx_CircleOfLight[];
extern const u8 gBattleAnimSpriteGfx_Electricity[];
extern const u8 gBattleAnimSpriteGfx_Finger2[];
extern const u8 gBattleAnimSpriteGfx_MovementWaves[];
extern const u8 gBattleAnimSpriteGfx_MagentaHeart[];
extern const u8 gBattleAnimSpriteGfx_RedOrb[];
extern const u8 gBattleAnimSpriteGfx_EyeSparkle[];
extern const u8 gBattleAnimSpriteGfx_MagentaHeart[];
extern const u8 gBattleAnimSpriteGfx_Angel[];
extern const u8 gBattleAnimSpriteGfx_Devil[];
extern const u8 gBattleAnimSpriteGfx_Swipe[];
extern const u8 gBattleAnimSpriteGfx_Roots[];
extern const u8 gBattleAnimSpriteGfx_ItemBag[];
extern const u8 gBattleAnimSpriteGfx_JaggedMusicNote[];
extern const u8 gBattleAnimSpriteGfx_Pokeball[];
extern const u8 gBattleAnimSpriteGfx_Spotlight[];
extern const u8 gBattleAnimSpriteGfx_LetterZ[];
extern const u8 gBattleAnimSpriteGfx_RapidSpin[];
extern const u8 gBattleAnimSpriteGfx_TriAttackTriangle[];
extern const u8 gBattleAnimSpriteGfx_WispOrb[];
extern const u8 gBattleAnimSpriteGfx_WispFire[];
extern const u8 gBattleAnimSpriteGfx_GoldStars[];
extern const u8 gBattleAnimSpriteGfx_EclipsingOrb[];
extern const u8 gBattleAnimSpriteGfx_GrayOrb[];
extern const u8 gBattleAnimSpriteGfx_GrayOrb[];
extern const u8 gBattleAnimSpriteGfx_GrayOrb[];
extern const u8 gBattleAnimSpriteGfx_PinkPetal[];
extern const u8 gBattleAnimSpriteGfx_PainSplit[];
extern const u8 gBattleAnimSpriteGfx_Confetti[];
extern const u8 gBattleAnimSpriteGfx_GreenStar[];
extern const u8 gBattleAnimSpriteGfx_PinkCloud[];
extern const u8 gBattleAnimSpriteGfx_SweatDrop[];
extern const u8 gBattleAnimSpriteGfx_GuardRing[];
extern const u8 gBattleAnimSpriteGfx_PurpleScratch[];
extern const u8 gBattleAnimSpriteGfx_PurpleSwipe[];
extern const u8 gBattleAnimSpriteGfx_TagHand[];
extern const u8 gBattleAnimSpriteGfx_SmallRedEye[];
extern const u8 gBattleAnimSpriteGfx_HollowOrb[];
extern const u8 gBattleAnimSpriteGfx_XSign[];
extern const u8 gBattleAnimSpriteGfx_BluegreenOrb[];
extern const u8 gBattleAnimSpriteGfx_PawPrint[];
extern const u8 gBattleAnimSpriteGfx_PurpleFlame[];
extern const u8 gBattleAnimSpriteGfx_RedBall[];
extern const u8 gBattleAnimSpriteGfx_SmellingsaltEffect[];
extern const u8 gBattleAnimSpriteGfx_Meteor[];
extern const u8 gBattleAnimSpriteGfx_FlatRock[];
extern const u8 gBattleAnimSpriteGfx_MagnifyingGlass[];
extern const u8 gBattleAnimSpriteGfx_MetalSoundWaves[];
extern const u8 gBattleAnimSpriteGfx_FlyingDirt[];
extern const u8 gBattleAnimSpriteGfx_IcicleSpear[];
extern const u8 gBattleAnimSpriteGfx_Hail[];
extern const u8 gBattleAnimSpriteGfx_GlowyRedOrb[];
extern const u8 gBattleAnimSpriteGfx_GreenSpike[];
extern const u8 gBattleAnimSpriteGfx_Pokeblock[];
extern const u8 gBattleAnimSpriteGfx_WhiteFeather[];
extern const u8 gBattleAnimSpriteGfx_Sparkle6[];
extern const u8 gBattleAnimSpriteGfx_Splash[];
extern const u8 gBattleAnimSpriteGfx_SweatBead[];
extern const u8 gBattleAnimSpriteGfx_Gem1[];
extern const u8 gBattleAnimSpriteGfx_Gem2[];
extern const u8 gBattleAnimSpriteGfx_Gem3[];
extern const u8 gBattleAnimSpriteGfx_SlamHit2[];
extern const u8 gBattleAnimSpriteGfx_Recycle[];
extern const u8 gBattleAnimSpriteGfx_RedParticles[];
extern const u8 gBattleAnimSpriteGfx_Protect[];
extern const u8 gBattleAnimSpriteGfx_DirtMound[];
extern const u8 gBattleAnimSpriteGfx_Shock3[];
extern const u8 gBattleAnimSpriteGfx_WeatherBall[];
...
extern const u8 gBattleAnimSpriteGfx_Bird[];
extern const u8 gBattleAnimSpriteGfx_CrossImpact[];
...
extern const u8 gBattleAnimBgImage_ScaryFace[];
...
extern const u8 gBattleAnimBgImage_Dark[];
extern const u8 gBattleAnimBgImage_Ghost[];
extern const u8 gBattleAnimBgImage_Psychic[];
extern const u8 gBattleAnimBgImage_Impact[];
extern const u8 gBattleAnimBgImage_Drill[];
extern const u8 gBattleAnimBgImage_Highspeed[];
extern const u8 gBattleAnimBgImage_Thunder[];
extern const u8 gBattleAnimBgImage_Guillotine[];
extern const u8 gBattleAnimBgImage_Ice[];
extern const u8 gBattleAnimBgImage_Cosmic[];
extern const u8 gBattleAnimBgImage_InAir[];
extern const u8 gBattleAnimBgImage_Aurora[];
extern const u8 gBattleAnimBgImage_Fissure[];
...
extern const u8 gBattleAnimMaskImage_LightBeam[];
...
extern const u8 gMetalShineGfx[];
extern const u32 gMetalShinePalette[];
extern const u32 gMetalShineTilemap[];

extern const u8 gBattleAnimMaskImage_Curse[];
...
extern const u8 gContestInterfaceGfx[];
...
extern const u8 gContestFaces_Gfx[];
...
extern const u8 gBattleAnimBgImage_Surf[];
extern const u32 gBattleAnimBgPalette_Surf[];
extern const u32 gBattleAnimBackgroundImageMuddyWater_Pal[];

extern const u8 gEnemyMonShadow_Gfx[];

extern const u32 gBattleAnimFogTilemap[];

extern const u8 gUsePokeblockGraph_Gfx[];
...
extern const u8 gBerryBlenderCenter_Gfx[];
extern const u8 gBerryBlenderOuter_Gfx[];
extern const u8 gBerryBlenderOuter_Tilemap[];

// Slot Machine
extern const u8 gSlotMachineDigitalDisplay_Gfx[];
...
// Pokedex Area Screen
extern const u8 gPokedexAreaScreenAreaUnknown_Gfx[];
extern const u16 gPokedexAreaScreenAreaUnknown_Pal[];

// Pokemon Storage System
extern const u8 gStorageSystemMenu_Gfx[];
...
extern const u8 gCableCarCable_Gfx[];
...
// Party menu
extern const u8 gPartyMenuPokeball_Gfx[];
extern const u8 gPartyMenuPokeballSmall_Gfx[];
extern const u32 gStatusPal_Icons[];
extern const u32 gPartyMenuPokeball_Pal[];
extern const u32 gStatusPal_Icons[];

// Roulette
extern const u8 gRouletteMenu_Gfx[];
extern const u8 gRouletteWheel_Gfx[];
extern const u8 gRouletteCenter_Gfx[];
extern const u8 gRouletteHeaders_Gfx[];
extern const u8 gRouletteCredit_Gfx[];
extern const u8 gRouletteNumbers_Gfx[];
extern const u8 gRouletteMultiplier_Gfx[];
...
extern const u8 gHoennTrainerCard_Gfx[];
extern const u16 gKantoTrainerCard0Star_Pal[];
extern const u8 gKantoTrainerCard_Gfx[];
...
// Easy Chat Screen
extern const u8 gEasyChatWindow_Gfx[];
extern const u32 gEasyChatWindow_Tilemap[];
extern const u8 gEasyChatMode_Gfx[];
extern const u16 gEasyChatMode_Pal[];
extern const u8 gEasyChatRectangleCursor_Gfx[];
extern const u16 gEasyChatRectangleCursor_Pal[];
extern const u8 gEasyChatButtonWindow_Gfx[];
extern const u16 gEasyChatButtonWindow_Pal[];

// Use Pokeblock
extern const u8 gUsePokeblockCondition_Gfx[];

// Union Room Chat
extern const u16 gUnionRoomChat_Background_Pal[];
extern const u8 gUnionRoomChat_Background_Gfx[];
...
extern const u8 gUnionRoomChat_Border_Gfx[];
extern const u32 gUnionRoomChat_Border_Tilemap[];
extern const u8 gUnionRoomChat_RButtonLabels[];
